...
LibStub("LibPeriodicTable-3.1"):AddData("Consumable", gsub("$Rev: 295 $", "(%d+)", function(n) return n+90000 end), {
	...
	["Consumable.Food.Edible.Bread.Combo.Conjured"]="65517:4320,34062:7500,43518:13200,43523:15000",
