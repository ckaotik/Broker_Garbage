...
if GetLocale() == "zhTW" then
	...
	-- Chat Messages
	BGLM.locale.couldNotLootValue = "沒有捨取%sx%d，因為太便宜。"
	BGLM.locale.couldNotLootCompareValue = "沒有捨取%sx%d。它比我們已經有的還要便宜。背包滿了!"
	BGLM.locale.couldNotLootBlacklist = "沒有捨取%sx%d，因為它在你的垃圾列表。"
	BGLM.locale.couldNotLootLocked = "無法捨取%sx%d，因為它被鎖定。請手動捨取。"
	BGLM.locale.couldNotLootSpace = "無法捨取%sx%d，因為你沒有任何空間。"
	...
	-- BGLM.locale.LMAutoDestroy_ErrorNoItems = "Error! I tried to make space but there is nothing left for me to delete!"
