...
if GetLocale() == "zhTW" then
	...
	-- BGC.locale.GroupOutput = "Text Output"
	...
	-- BGC.locale.keepMaxItemLevelTitle = "Keep highest iLvl"
	-- BGC.locale.keepMaxItemLevelText = "Check to keep the highest item level gear when selling outdated gear."
